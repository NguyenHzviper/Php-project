...
if(isset($_POST["add_book"]))
{
	...
	if($error == '')
	{
        ...
        (book_category, book_author, book_location_rack, book_name, book_isbn_number, book_no_of_copy, book_status, book_added_on, book_updated_on) 
        VALUES (:book_category, :book_author, :book_location_rack, :book_name, :book_isbn_number, :book_no_of_copy, :book_status, :book_added_on, :book_updated_on)
		";
